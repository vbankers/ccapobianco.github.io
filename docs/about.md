<div class="about-header">
  <img src="assets/profile.jpg"  class="about-avatar" width="160" height="160" loading="lazy" />
  ...
  <a href="mailto:ccapobianco@ethz.ch" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
